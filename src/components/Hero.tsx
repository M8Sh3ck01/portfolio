  ...
  return (
    <section id="top" className="scroll-mt-24 px-3 pt-16 pb-6 sm:px-4 sm:pb-8">
      <Frame className="flex min-h-[calc(100dvh-5rem)] max-w-none shadow-none">
        <div
          aria-hidden
          className="pointer-events-none absolute -right-44 top-1/2 h-[560px] w-[560px] -translate-y-1/2 rounded-full bg-accent opacity-[0.14] blur-[130px]"
        />
            ...
            <div className="relative mt-16 flex justify-center lg:-mt-16 lg:justify-end">
              <div className="relative w-60 sm:w-80 lg:h-[min(76vh,600px)] lg:w-auto">
                ...
                <img
                  ...
                  className="relative z-10 block h-60 w-60 object-contain drop-shadow-[0_18px_50px_rgba(0,0,0,0.45)] sm:h-80 sm:w-80 lg:h-full lg:w-auto lg:translate-x-6"
                />
              </div>
            </div>
          </div>
